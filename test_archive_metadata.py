...
class MetadataTests(unittest.TestCase):
    def test_supported_source_names_keep_early_and_late_distinct(self):
        self.assertEqual(archive_identity('titled-tuesday_2024-01-02a.pgn'), ('2024-01-02', 'a'))
        self.assertEqual(archive_identity('titled-tuesday_2024-01-02b.zip'), ('2024-01-02', 'b'))
        self.assertEqual(archive_identity('titled-tuesday_2021-05-04.pgn'), ('2021-05-04', ''))
        ...
        # Legacy standardized names remain readable for migration.
    ...
    def test_metadata_links_use_forward_slashes(self):
        entry = entry_metadata('titled-tuesday_2024-01-02a.zip', 'titled-tuesday_2024-01-02a.pgn', 'Titled Tuesday', 10, 'a' * 64)
        self.assertEqual(entry['session'], 'early')
        self.assertEqual(entry['date'], '2024-01-02')
        self.assertIn('/2024/titled-tuesday_2024-01-02a.zip', render_metadata([entry])['tt_links.txt'])
